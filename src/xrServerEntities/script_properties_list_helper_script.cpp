...
void CScriptPropertiesListHelper::script_register(lua_State* luaState)
{
    ...
    [
        ...
        class_<CScriptPropertiesListHelper>("properties_list_helper")
            ...
            .def("create_choose",
                (ChooseValue * (CScriptPropertiesListHelper::*)(PropItemVec*, pcstr, luabind::object, pcstr,
                                   u32))(&CScriptPropertiesListHelper::CreateChoose))
            .def("create_choose",
                (ChooseValue * (CScriptPropertiesListHelper::*)(PropItemVec*, pcstr, luabind::object, pcstr, u32,
                                   pcstr))(&CScriptPropertiesListHelper::CreateChoose))
            .def("create_choose",
                (ChooseValue * (CScriptPropertiesListHelper::*)(PropItemVec*, pcstr, luabind::object, pcstr, u32,
                                   pcstr, pcstr))(&CScriptPropertiesListHelper::CreateChoose))
            .def("create_choose",
                (ChooseValue * (CScriptPropertiesListHelper::*)(PropItemVec*, pcstr, luabind::object, pcstr, u32,
                                   pcstr, pcstr, u32))(&CScriptPropertiesListHelper::CreateChoose))

            //			.def("create_s8", (S8Value *(CScriptPropertiesListHelper::*)(PropItemVec*, pcstr,
            //luabind::object , pcstr
            ...
            .def("create_s16", (S16Value * (CScriptPropertiesListHelper::*)(PropItemVec*, pcstr, luabind::object,
                                               pcstr))(&CScriptPropertiesListHelper::CreateS16))
            .def("create_s16", (S16Value * (CScriptPropertiesListHelper::*)(PropItemVec*, pcstr, luabind::object,
                                               pcstr, s16))(&CScriptPropertiesListHelper::CreateS16))
            .def("create_s16", (S16Value * (CScriptPropertiesListHelper::*)(PropItemVec*, pcstr, luabind::object,
                                               pcstr, s16, s16))(&CScriptPropertiesListHelper::CreateS16))
            .def("create_s16", (S16Value * (CScriptPropertiesListHelper::*)(PropItemVec*, pcstr, luabind::object,
                                               pcstr, s16, s16, s16))(&CScriptPropertiesListHelper::CreateS16))

            .def("create_s32", (S32Value * (CScriptPropertiesListHelper::*)(PropItemVec*, pcstr, luabind::object,
                                               pcstr))(&CScriptPropertiesListHelper::CreateS32))
            .def("create_s32", (S32Value * (CScriptPropertiesListHelper::*)(PropItemVec*, pcstr, luabind::object,
                                               pcstr, s32))(&CScriptPropertiesListHelper::CreateS32))
            .def("create_s32", (S32Value * (CScriptPropertiesListHelper::*)(PropItemVec*, pcstr, luabind::object,
                                               pcstr, s32, s32))(&CScriptPropertiesListHelper::CreateS32))
            .def("create_s32", (S32Value * (CScriptPropertiesListHelper::*)(PropItemVec*, pcstr, luabind::object,
                                               pcstr, s32, s32, s32))(&CScriptPropertiesListHelper::CreateS32))

            .def("create_u8", (U8Value * (CScriptPropertiesListHelper::*)(PropItemVec*, pcstr, luabind::object,
                                             pcstr))(&CScriptPropertiesListHelper::CreateU8))
            .def("create_u8", (U8Value * (CScriptPropertiesListHelper::*)(PropItemVec*, pcstr, luabind::object,
                                             pcstr, u8))(&CScriptPropertiesListHelper::CreateU8))
            .def("create_u8", (U8Value * (CScriptPropertiesListHelper::*)(PropItemVec*, pcstr, luabind::object,
                                             pcstr, u8, u8))(&CScriptPropertiesListHelper::CreateU8))
            .def("create_u8", (U8Value * (CScriptPropertiesListHelper::*)(PropItemVec*, pcstr, luabind::object,
                                             pcstr, u8, u8, u8))(&CScriptPropertiesListHelper::CreateU8))

            .def("create_u16", (U16Value * (CScriptPropertiesListHelper::*)(PropItemVec*, pcstr, luabind::object,
                                               pcstr))(&CScriptPropertiesListHelper::CreateU16))
            .def("create_u16", (U16Value * (CScriptPropertiesListHelper::*)(PropItemVec*, pcstr, luabind::object,
                                               pcstr, u16))(&CScriptPropertiesListHelper::CreateU16))
            .def("create_u16", (U16Value * (CScriptPropertiesListHelper::*)(PropItemVec*, pcstr, luabind::object,
                                               pcstr, u16, u16))(&CScriptPropertiesListHelper::CreateU16))
            .def("create_u16", (U16Value * (CScriptPropertiesListHelper::*)(PropItemVec*, pcstr, luabind::object,
                                               pcstr, u16, u16, u16))(&CScriptPropertiesListHelper::CreateU16))

            .def("create_u32", (U32Value * (CScriptPropertiesListHelper::*)(PropItemVec*, pcstr, luabind::object,
                                               pcstr))(&CScriptPropertiesListHelper::CreateU32))
            .def("create_u32", (U32Value * (CScriptPropertiesListHelper::*)(PropItemVec*, pcstr, luabind::object,
                                               pcstr, u32))(&CScriptPropertiesListHelper::CreateU32))
            .def("create_u32", (U32Value * (CScriptPropertiesListHelper::*)(PropItemVec*, pcstr, luabind::object,
                                               pcstr, u32, u32))(&CScriptPropertiesListHelper::CreateU32))
            .def("create_u32", (U32Value * (CScriptPropertiesListHelper::*)(PropItemVec*, pcstr, luabind::object,
                                               pcstr, u32, u32, u32))(&CScriptPropertiesListHelper::CreateU32))

            .def("create_float",
                (FloatValue * (CScriptPropertiesListHelper::*)(PropItemVec*, pcstr, luabind::object, pcstr))(
                    &CScriptPropertiesListHelper::CreateFloat))
            .def("create_float",
                (FloatValue * (CScriptPropertiesListHelper::*)(PropItemVec*, pcstr, luabind::object, pcstr,
                                  float))(&CScriptPropertiesListHelper::CreateFloat))
            .def("create_float",
                (FloatValue * (CScriptPropertiesListHelper::*)(PropItemVec*, pcstr, luabind::object, pcstr, float,
                                  float))(&CScriptPropertiesListHelper::CreateFloat))
            .def("create_float",
                (FloatValue * (CScriptPropertiesListHelper::*)(PropItemVec*, pcstr, luabind::object, pcstr, float,
            ...
            .def("create_vector",
                (VectorValue * (CScriptPropertiesListHelper::*)(PropItemVec*, pcstr, luabind::object, pcstr))(
            ...
            .def("create_flag8",
                (Flag8Value * (CScriptPropertiesListHelper::*)(PropItemVec*, pcstr, luabind::object, pcstr, u8))(
                    &CScriptPropertiesListHelper::CreateFlag8))
            .def("create_flag8",
                (Flag8Value * (CScriptPropertiesListHelper::*)(PropItemVec*, pcstr, luabind::object, pcstr, u8,
                                  pcstr))(&CScriptPropertiesListHelper::CreateFlag8))
            .def("create_flag8",
                (Flag8Value * (CScriptPropertiesListHelper::*)(PropItemVec*, pcstr, luabind::object, pcstr, u8,
                                  pcstr, pcstr))(&CScriptPropertiesListHelper::CreateFlag8))
            .def("create_flag8",
                (Flag8Value * (CScriptPropertiesListHelper::*)(PropItemVec*, pcstr, luabind::object, pcstr, u8,
                                  pcstr, pcstr, u32))(&CScriptPropertiesListHelper::CreateFlag8))

            .def("create_flag16",
                (Flag16Value * (CScriptPropertiesListHelper::*)(PropItemVec*, pcstr, luabind::object, pcstr,
                                   u16))(&CScriptPropertiesListHelper::CreateFlag16))
            .def("create_flag16",
                (Flag16Value * (CScriptPropertiesListHelper::*)(PropItemVec*, pcstr, luabind::object, pcstr, u16,
                                   pcstr))(&CScriptPropertiesListHelper::CreateFlag16))
            .def("create_flag16",
                (Flag16Value * (CScriptPropertiesListHelper::*)(PropItemVec*, pcstr, luabind::object, pcstr, u16,
                                   pcstr, pcstr))(&CScriptPropertiesListHelper::CreateFlag16))
            .def("create_flag16",
                (Flag16Value * (CScriptPropertiesListHelper::*)(PropItemVec*, pcstr, luabind::object, pcstr, u16,
                                   pcstr, pcstr, u32))(&CScriptPropertiesListHelper::CreateFlag16))

            .def("create_flag32",
                (Flag32Value * (CScriptPropertiesListHelper::*)(PropItemVec*, pcstr, luabind::object, pcstr,
                                   u32))(&CScriptPropertiesListHelper::CreateFlag32))
            .def("create_flag32",
                (Flag32Value * (CScriptPropertiesListHelper::*)(PropItemVec*, pcstr, luabind::object, pcstr, u32,
                                   pcstr))(&CScriptPropertiesListHelper::CreateFlag32))
            .def("create_flag32",
                (Flag32Value * (CScriptPropertiesListHelper::*)(PropItemVec*, pcstr, luabind::object, pcstr, u32,
                                   pcstr, pcstr))(&CScriptPropertiesListHelper::CreateFlag32))
            .def("create_flag32",
                (Flag32Value * (CScriptPropertiesListHelper::*)(PropItemVec*, pcstr, luabind::object, pcstr, u32,
                                   pcstr, pcstr, u32))(&CScriptPropertiesListHelper::CreateFlag32))
            ...
            .def(
                "create_time", (FloatValue * (CScriptPropertiesListHelper::*)(PropItemVec*, pcstr, luabind::object,
                                                 pcstr, float))(&CScriptPropertiesListHelper::CreateTime))
            .def(
                "create_time", (FloatValue * (CScriptPropertiesListHelper::*)(PropItemVec*, pcstr, luabind::object,
                                                 pcstr, float, float))(&CScriptPropertiesListHelper::CreateTime))
        ...
        def("properties_helper", +[]
        {
            if (!g_property_list_helper)
                GEnv.ScriptEngine->script_log(LuaMessageType::Error,
                "Editor is not started, therefore prop_helper cannot be accessed!");
