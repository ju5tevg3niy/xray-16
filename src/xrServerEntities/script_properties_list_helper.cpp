...
template <typename T>
static auto* wrap_value(const luabind::object& object, pcstr name)
{
    constexpr bool condition = std::is_class_v<T> && !object_type_traits::is_same<shared_str, T>::value;
    return CWrapHelper<T, condition>::wrap_value(object, name);
}
...
/*
void CScriptPropertiesListHelper::floatRDOnDraw			(PropValue* sender,  pcstr& draw_val)
{
    shared_str		temp;
...
bool CScriptPropertiesListHelper::NameAfterEdit(PropValue* sender, pcstr& edit_val)
{
    shared_str temp;
...
void CScriptPropertiesListHelper::NameBeforeEdit(PropValue* sender, pcstr& edit_val)
{
    shared_str temp;
...
/*
void CScriptPropertiesListHelper::NameDraw				(PropValue* sender,  pcstr& draw_val)
{
    shared_str		temp;
...
CaptionValue* CScriptPropertiesListHelper::CreateCaption(PropItemVec* items, pcstr key, pcstr val)
{
    return (PHelper().CreateCaption(*items, key, val));
}

CanvasValue* CScriptPropertiesListHelper::CreateCanvas(PropItemVec* items, pcstr key, pcstr val, int height)
{
    return (PHelper().CreateCanvas(*items, key, val, height));
}

ButtonValue* CScriptPropertiesListHelper::CreateButton(PropItemVec* items, pcstr key, pcstr val, u32 flags)
{
    return (PHelper().CreateButton(*items, key, val, flags));
}

ChooseValue* CScriptPropertiesListHelper::CreateChoose(PropItemVec* items, pcstr key, luabind::object object,
    pcstr name, u32 mode, pcstr path, pcstr fill_param, u32 sub_item_cnt)
{
...
ChooseValue* CScriptPropertiesListHelper::CreateChoose(
    PropItemVec* items, pcstr key, luabind::object object, pcstr name, u32 mode)
{
    return (PHelper().CreateChoose(*items, key, wrap_value<shared_str>(object, name), mode, nullptr));
}

// S8Value* CScriptPropertiesListHelper::CreateS8		(PropItemVec* items, pcstr key, luabind::object object, pcstr
// name,
// s8 mn,  s8 mx,  s8 inc)
//{
...
S16Value* CScriptPropertiesListHelper::CreateS16(
    PropItemVec* items, pcstr key, luabind::object object, pcstr name, s16 mn, s16 mx, s16 inc)
{
    return (PHelper().CreateS16(*items, key, wrap_value<s16>(object, name), mn, mx, inc));
}

S16Value* CScriptPropertiesListHelper::CreateS16(
    PropItemVec* items, pcstr key, luabind::object object, pcstr name, s16 mn, s16 mx)
{
    return (PHelper().CreateS16(*items, key, wrap_value<s16>(object, name), mn, mx));
}

S16Value* CScriptPropertiesListHelper::CreateS16(
    PropItemVec* items, pcstr key, luabind::object object, pcstr name, s16 mn)
{
    return (PHelper().CreateS16(*items, key, wrap_value<s16>(object, name), mn));
}

S16Value* CScriptPropertiesListHelper::CreateS16(PropItemVec* items, pcstr key, luabind::object object, pcstr name)
{
    return (PHelper().CreateS16(*items, key, wrap_value<s16>(object, name)));
}

S32Value* CScriptPropertiesListHelper::CreateS32(
    PropItemVec* items, pcstr key, luabind::object object, pcstr name, s32 mn, s32 mx, s32 inc)
{
    return (PHelper().CreateS32(*items, key, wrap_value<s32>(object, name), mn, mx, inc));
}

S32Value* CScriptPropertiesListHelper::CreateS32(
    PropItemVec* items, pcstr key, luabind::object object, pcstr name, s32 mn, s32 mx)
{
    return (PHelper().CreateS32(*items, key, wrap_value<s32>(object, name), mn, mx));
}

S32Value* CScriptPropertiesListHelper::CreateS32(
    PropItemVec* items, pcstr key, luabind::object object, pcstr name, s32 mn)
{
    return (PHelper().CreateS32(*items, key, wrap_value<s32>(object, name), mn));
}

S32Value* CScriptPropertiesListHelper::CreateS32(PropItemVec* items, pcstr key, luabind::object object, pcstr name)
{
    return (PHelper().CreateS32(*items, key, wrap_value<s32>(object, name)));
}

U8Value* CScriptPropertiesListHelper::CreateU8(
    PropItemVec* items, pcstr key, luabind::object object, pcstr name, u8 mn, u8 mx, u8 inc)
{
    return (PHelper().CreateU8(*items, key, wrap_value<u8>(object, name), mn, mx, inc));
}

U8Value* CScriptPropertiesListHelper::CreateU8(
    PropItemVec* items, pcstr key, luabind::object object, pcstr name, u8 mn, u8 mx)
{
    return (PHelper().CreateU8(*items, key, wrap_value<u8>(object, name), mn, mx));
}

U8Value* CScriptPropertiesListHelper::CreateU8(
    PropItemVec* items, pcstr key, luabind::object object, pcstr name, u8 mn)
{
    return (PHelper().CreateU8(*items, key, wrap_value<u8>(object, name), mn));
}

U8Value* CScriptPropertiesListHelper::CreateU8(PropItemVec* items, pcstr key, luabind::object object, pcstr name)
{
    return (PHelper().CreateU8(*items, key, wrap_value<u8>(object, name)));
}

U16Value* CScriptPropertiesListHelper::CreateU16(
    PropItemVec* items, pcstr key, luabind::object object, pcstr name, u16 mn, u16 mx, u16 inc)
{
    return (PHelper().CreateU16(*items, key, wrap_value<u16>(object, name), mn, mx, inc));
}

U16Value* CScriptPropertiesListHelper::CreateU16(
    PropItemVec* items, pcstr key, luabind::object object, pcstr name, u16 mn, u16 mx)
{
    return (PHelper().CreateU16(*items, key, wrap_value<u16>(object, name), mn, mx));
}

U16Value* CScriptPropertiesListHelper::CreateU16(
    PropItemVec* items, pcstr key, luabind::object object, pcstr name, u16 mn)
{
    return (PHelper().CreateU16(*items, key, wrap_value<u16>(object, name), mn));
}

U16Value* CScriptPropertiesListHelper::CreateU16(PropItemVec* items, pcstr key, luabind::object object, pcstr name)
{
    return (PHelper().CreateU16(*items, key, wrap_value<u16>(object, name)));
}

U32Value* CScriptPropertiesListHelper::CreateU32(
    PropItemVec* items, pcstr key, luabind::object object, pcstr name, u32 mn, u32 mx, u32 inc)
{
    return (PHelper().CreateU32(*items, key, wrap_value<u32>(object, name), mn, mx, inc));
}

U32Value* CScriptPropertiesListHelper::CreateU32(
    PropItemVec* items, pcstr key, luabind::object object, pcstr name, u32 mn, u32 mx)
{
    return (PHelper().CreateU32(*items, key, wrap_value<u32>(object, name), mn, mx));
}

U32Value* CScriptPropertiesListHelper::CreateU32(
    PropItemVec* items, pcstr key, luabind::object object, pcstr name, u32 mn)
{
    return (PHelper().CreateU32(*items, key, wrap_value<u32>(object, name), mn));
}

U32Value* CScriptPropertiesListHelper::CreateU32(PropItemVec* items, pcstr key, luabind::object object, pcstr name)
{
...
FloatValue* CScriptPropertiesListHelper::CreateFloat(
    PropItemVec* items, pcstr key, luabind::object object, pcstr name, float mn, float mx)
{
    return (PHelper().CreateFloat(*items, key, wrap_value<float>(object, name), mn, mx));
}

FloatValue* CScriptPropertiesListHelper::CreateFloat(
    PropItemVec* items, pcstr key, luabind::object object, pcstr name, float mn)
{
    return (PHelper().CreateFloat(*items, key, wrap_value<float>(object, name), mn));
}

FloatValue* CScriptPropertiesListHelper::CreateFloat(
    PropItemVec* items, pcstr key, luabind::object object, pcstr name)
{
    return (PHelper().CreateFloat(*items, key, wrap_value<float>(object, name)));
}

BOOLValue* CScriptPropertiesListHelper::CreateBOOL(
    PropItemVec* items, pcstr key, luabind::object object, luabind::object table, pcstr name)
{
...
Flag8Value* CScriptPropertiesListHelper::CreateFlag8(
    PropItemVec* items, pcstr key, luabind::object object, pcstr name, u8 mask, pcstr c0)
{
    return (PHelper().CreateFlag8(*items, key, wrap_value<Flags8>(object, name), mask, c0));
}

Flag8Value* CScriptPropertiesListHelper::CreateFlag8(
    PropItemVec* items, pcstr key, luabind::object object, pcstr name, u8 mask)
{
...
Flag16Value* CScriptPropertiesListHelper::CreateFlag16(
    PropItemVec* items, pcstr key, luabind::object object, pcstr name, u16 mask, pcstr c0)
{
    return (PHelper().CreateFlag16(*items, key, wrap_value<Flags16>(object, name), mask, c0));
}

Flag16Value* CScriptPropertiesListHelper::CreateFlag16(
    PropItemVec* items, pcstr key, luabind::object object, pcstr name, u16 mask)
{
...
Flag32Value* CScriptPropertiesListHelper::CreateFlag32(
    PropItemVec* items, pcstr key, luabind::object object, pcstr name, u32 mask, pcstr c0)
{
    return (PHelper().CreateFlag32(*items, key, wrap_value<Flags32>(object, name), mask, c0));
}

Flag32Value* CScriptPropertiesListHelper::CreateFlag32(
    PropItemVec* items, pcstr key, luabind::object object, pcstr name, u32 mask)
{
...
/*
RToken8Value*	CScriptPropertiesListHelper::CreateRToken8	(PropItemVec* items, pcstr key, luabind::object object,
pcstr name, xr_rtoken* token, u32 t_cnt)
{
    return		(PHelper().CreateRToken8(*items,key,wrap_value<shared_str>(object,name),token));
}

RToken16Value*	CScriptPropertiesListHelper::CreateRToken16	(PropItemVec* items, pcstr key, luabind::object
object, pcstr name, std::vector<xr_rtoken>* token)
{
    return		(PHelper().CreateRToken16(*items,key,wrap_value<shared_str>(object,name),token));
}

RToken32Value*	CScriptPropertiesListHelper::CreateRToken32	(PropItemVec* items, pcstr key, luabind::object
object, pcstr name, std::vector<xr_rtoken>* token)
{
...
U32Value* CScriptPropertiesListHelper::CreateColor(PropItemVec* items, pcstr key, luabind::object object, pcstr name)
{
    return (PHelper().CreateColor(*items, key, wrap_value<u32>(object, name)));
}

ColorValue* CScriptPropertiesListHelper::CreateFColor(
    PropItemVec* items, pcstr key, luabind::object object, pcstr name)
{
    return (PHelper().CreateFColor(*items, key, wrap_value<Fcolor>(object, name)));
}

VectorValue* CScriptPropertiesListHelper::CreateVColor(
    PropItemVec* items, pcstr key, luabind::object object, pcstr name)
{
    return (PHelper().CreateVColor(*items, key, wrap_value<Fvector>(object, name)));
}

RTextValue* CScriptPropertiesListHelper::CreateRText(
    PropItemVec* items, pcstr key, luabind::object object, pcstr name)
{
...
FloatValue* CScriptPropertiesListHelper::CreateTime(PropItemVec* items, pcstr key, luabind::object object, pcstr name)
{
