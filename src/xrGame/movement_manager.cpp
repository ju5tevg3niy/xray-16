...
const std::vector<DetailPathManager::STravelPathPoint>& CMovementManager::path() const { return (detail().path()); }
...
CRestrictedObject* CMovementManager::create_restricted_object() { return (xr_new<CRestrictedObject>(m_object)); }
