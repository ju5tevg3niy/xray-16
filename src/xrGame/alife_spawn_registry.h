...
protected:
    ...
    void fill_new_spawns(SPAWN_GRAPH::CVertex* vertex, std::vector<ALife::_SPAWN_ID>& spawns, ALife::_TIME_ID game_time,
    ...
    IC bool object_existance_limit(CSE_Abstract& abstract, std::vector<ALife::_SPAWN_ID>& objects) const;
    IC bool can_spawn(CSE_Abstract& abstract, ALife::_TIME_ID game_time, std::vector<ALife::_SPAWN_ID>& objects) const;
...
public:
    ...
    void fill_new_spawns(
        std::vector<ALife::_SPAWN_ID>& spawns, ALife::_TIME_ID game_time, std::vector<ALife::_SPAWN_ID>& objects);
