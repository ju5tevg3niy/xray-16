...
s32 seed_generator::genrate() { return m_random.randI(); }
...
inline u32 xray_crypt(void* buffer, u32 buffer_size, key_t const& sec_key, enum_xray_crypt_action crypt_action)
{
    s32 last_word = -1;
