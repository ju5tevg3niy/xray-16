...
IC const std::vector<DetailPathManager::STravelPathPoint>& CDetailPathManager::path() const { return (m_path); }
...
#ifdef DEBUG
IC std::vector<CDetailPathManager::STravelPoint>& CDetailPathManager::key_points() { return (m_key_points); }
#endif // DEBUG
