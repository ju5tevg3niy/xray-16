...
protected:
    ...
    void CreateList(std::vector<CUIStatic*>& lst, CUIXml& xml_doc, LPCSTR path, bool required = true);
    void ShowMain();
    void ShowNewGame();
    ...
    std::vector<CUIStatic*> m_buttons;
    std::vector<CUIStatic*> m_buttons_new;
    std::vector<CUIStatic*> m_buttons_new_network;
