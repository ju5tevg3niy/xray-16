...
CUIFrags::CUIFrags()
{
    m_pBackT = xr_new<CUIStatic>();
    AttachChild(m_pBackT);
    m_pBackC = xr_new<CUIStatic>();
    AttachChild(m_pBackC);
    m_pBackB = xr_new<CUIStatic>();
    AttachChild(m_pBackB);
    m_pStats = xr_new<CUIStats>();
    AttachChild(m_pStats);
}
