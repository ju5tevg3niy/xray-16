...
{
public:
    typedef std::vector<CMemberEnemy> ENEMIES;
    ...
    typedef std::vector<WOUNDED_ENEMY> WOUNDED_ENEMIES;
...
protected:
    template <typename T>
    IC void setup_mask(std::vector<T>& objects, CMemberEnemy& enemy, const squad_mask_type& non_combat_members);
