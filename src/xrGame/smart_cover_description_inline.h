...
{
IC shared_str const& description::table_id() const { return (m_table_id); }
IC description::Loopholes const& description::loopholes() const { return (m_loopholes); }
IC description::TransitionGraph const& description::transitions() const { return (m_transitions); }
} // namespace smart_cover
