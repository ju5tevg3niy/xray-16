...
public:
    ...
    IC virtual void DrawFaceNormal(
    ...
    IC virtual void DrawFaceNormal(const Fvector* p, float size, u32 clr)
    {
    ...
    IC virtual void DrawSelectionBoxB(const Fbox& box, u32* c = 0)
    {
        Fvector S, C;
        box.getsize(S);
        box.getcenter(C);
