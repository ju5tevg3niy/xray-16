...
public:
    ...
    // query
    void q_ray(
        std::vector<ISpatial*>& R, u32 _o, u32 _mask_and, const Fvector& _start, const Fvector& _dir, float _range);
    void q_box(std::vector<ISpatial*>& R, u32 _o, u32 _mask_or, const Fvector& _center, const Fvector& _size);
    void q_sphere(std::vector<ISpatial*>& R, u32 _o, u32 _mask_or, const Fvector& _center, const float _radius);
