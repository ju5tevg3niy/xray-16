...
IC void CLevelStraightLinePathManager::setup(const _Graph* _graph, _DataStorage* _data_storage,
    std::vector<_index_type>* _path, const _index_type& _start_node_index, const _index_type& _goal_node_index,
...
IC void CLevelStraightLinePathManager::create_path(T& vertex)
{
    ...
    typename std::vector<_index_type>::iterator I = CLevelStraightLinePathManager::path->begin();
    typename std::vector<_index_type>::iterator E = CLevelStraightLinePathManager::path->end();
