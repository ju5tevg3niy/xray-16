...
void CPhysicsElement::script_register(lua_State* L)
{
    ...
    [
        class_<CPhysicsElement>("physics_element")
            ...
            .def("global_transform", +[](const CPhysicsElement* E)
            {
                Fmatrix m;
...
void CPhysicsJoint::script_register(lua_State* L)
{
    ...
    [
        class_<CPhysicsJoint>("physics_joint")
            ...
            .def("set_anchor_global", (void (CPhysicsJoint::*)(const float, const float, const float))(
                                        &CPhysicsJoint::SetAnchor))
            ...
            .def("set_axis_dir_vs_first_element", (void (CPhysicsJoint::*)(const float, const float, const float,
                                                    const int))(&CPhysicsJoint::SetAxisDirVsFirstElement))
            .def("set_axis_dir_vs_second_element", (void (CPhysicsJoint::*)(const float, const float, const float,
                                                        const int))(&CPhysicsJoint::SetAxisDirVsSecondElement))
