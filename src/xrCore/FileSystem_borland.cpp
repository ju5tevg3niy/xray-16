...
bool EFS_Utils::GetOpenName(pcstr initial,
                            std::string& buffer,
                            bool bMulti,
                            pcstr offset,
                            int start_flt_ext) {
  ...
  */
   ...
   */
  // bool bRes = false;
  bool bRes = GetOpenNameInternal(initial, buf, sizeof(buf), bMulti, offset,
                                  start_flt_ext);
...
std::string EFS_Utils::AppendFolderToName(std::string& tex_name,
                                          int depth,
                                          BOOL full_name) {
  string1024 nm;
