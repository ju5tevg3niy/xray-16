...
#pragma pack(pop)
        ...
        typedef int ERROR_CantUsehorrible_cast[sizeof(function_to_bind) == sizeof(u.s) &&
                    sizeof(function_to_bind) == sizeof(u.ProbeFunc) && sizeof(u2.virtfunc) == sizeof(u2.s) ?
                1 :
                -1];
...
// RetType is the type which is returned from
...
public:
    ...
    FastDelegate() { clear(); }
    FastDelegate(const FastDelegate& x) { m_Closure.CopyFrom(this, x.m_Closure); }

    void operator=(const FastDelegate& x) { m_Closure.CopyFrom(this, x.m_Closure); }
    bool operator==(const FastDelegate& x) const { return m_Closure.IsEqual(x.m_Closure); }
    bool operator!=(const FastDelegate& x) const { return !m_Closure.IsEqual(x.m_Closure); }
    bool operator<(const FastDelegate& x) const { return m_Closure.IsLess(x.m_Closure); }
    bool operator>(const FastDelegate& x) const { return x.m_Closure.IsLess(m_Closure); }
...
// Part 4 is now the base of part 3
// Here comes the compatibility with original FastDelegate syntax

template < typename RetType = void >
using FastDelegate0 = FastDelegate<RetType()>;

template < typename Param1, typename RetType = void >
using FastDelegate1 = FastDelegate<RetType(Param1)>;

template < typename Param1, typename Param2, typename RetType = void >
using FastDelegate2 = FastDelegate<RetType(Param1, Param2)>;

template < typename Param1, typename Param2, typename Param3, typename RetType = void >
using FastDelegate3 = FastDelegate<RetType(Param1, Param2, Param3)>;

template < typename Param1, typename Param2, typename Param3, typename Param4, typename RetType = void >
using FastDelegate4 = FastDelegate<RetType(Param1, Param2, Param3, Param4)>;

template < typename Param1, typename Param2, typename Param3, typename Param4, typename Param5, typename RetType = void >
using FastDelegate5 = FastDelegate<RetType(Param1, Param2, Param3, Param4, Param5)>;

template < typename Param1, typename Param2, typename Param3, typename Param4, typename Param5, typename Param6, typename RetType = void >
using FastDelegate6 = FastDelegate<RetType(Param1, Param2, Param3, Param4, Param5, Param6)>;

template < typename Param1, typename Param2, typename Param3, typename Param4, typename Param5, typename Param6, typename Param7, typename RetType = void >
using FastDelegate7 = FastDelegate<RetType(Param1, Param2, Param3, Param4, Param5, Param6, Param6, Param7)>;

template < typename Param1, typename Param2, typename Param3, typename Param4, typename Param5, typename Param6, typename Param7, typename Param8, typename RetType = void >
using FastDelegate8 = FastDelegate<RetType(Param1, Param2, Param3, Param4, Param5, Param6, Param6, Param7, Param8)>;
