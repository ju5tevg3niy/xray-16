...
//  of a member function pointer, as used by the compiler. Template
...
struct SimplifyMemFunc {
  ...
  inline static GenericClass* Convert(X* pthis,
                                      ...
                                      GenericMemFuncType& bound_func) = delete;
};
...
class FastDelegate<RetType(Arguments...)> {
 ...
 public:
  ...
  inline void bind(Y* pthis,
                   RetType (X::*function_to_bind)(Arguments... args)) {
    m_Closure.bindmemfunc(detail::implicit_cast<X*>(pthis), function_to_bind);
  }
  ...
  FastDelegate(const Y* pthis,
               RetType (X::*function_to_bind)(Arguments... args) const) {
  ...
  FastDelegate(RetType (*function_to_bind)(Arguments... args)) {
    bind(function_to_bind);
  }

  // for efficiency, prevent creation of a temporary
  void operator=(RetType (*function_to_bind)(Arguments... args)) {
    bind(function_to_bind);
  }
  ...
  template <
      typename Invokable,
      std::enable_if_t<std::is_convertible_v<Invokable, StaticFunctionPtr>,
                       int> = 0>
...
template <typename Param1,
          ...
          typename RetType = void>
using FastDelegate5 =
    FastDelegate<RetType(Param1, Param2, Param3, Param4, Param5)>;
...
template <typename Param1,
          ...
          typename RetType = void>
using FastDelegate6 =
    FastDelegate<RetType(Param1, Param2, Param3, Param4, Param5, Param6)>;
...
template <typename Param1,
          ...
          typename Param7,
          typename RetType = void>
using FastDelegate7 = FastDelegate<
    RetType(Param1, Param2, Param3, Param4, Param5, Param6, Param6, Param7)>;
...
template <typename Param1,
          ...
          typename Param8,
          typename RetType = void>
using FastDelegate8 = FastDelegate<RetType(Param1,
                                           Param2,
                                           Param3,
                                           Param4,
                                           Param5,
...
template <typename RetType, typename... Arguments>
FastDelegate<RetType(Arguments...)> MakeDelegate(
    RetType (*func)(Arguments... args)) {
...
FastDelegate<RetType(Arguments...)> MakeDelegate(
    Y* x,
    RetType (X::*func)(Arguments... args) const) {
  return FastDelegate<RetType(Arguments...)>(x, func);
}
}  // namespace fastdelegate
