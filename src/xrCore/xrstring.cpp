...
str_value* str_container::dock(pcstr value) const {
  ...
  if (nullptr == result
    ...
    result =
        static_cast<str_value*>(xr_malloc(sizeof(str_value) + s_len_with_zero));
...
str_value* str_container::dock(str_c value) {
  ...
  // search
  str_container_impl::cdb::iterator I =
      impl->container.find(sv);  // only integer compares :)
