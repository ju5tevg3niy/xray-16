...
using ChooseItemVec = std::vector<SChooseItem>;

// typedef
typedef fastdelegate::FastDelegate2<ChooseItemVec&, void*> TOnChooseFillItems;
typedef fastdelegate::FastDelegate2<SChooseItem*, PropItemVec&>
    TOnChooseSelectItem;
...
struct SChooseEvents {
  ...
  SChooseEvents(LPCSTR capt,
                TOnChooseFillItems f,
                TOnChooseSelectItem s,
                TOnDrawThumbnail t,
                TOnChooseClose c,
                u32 fl) {
    Set(capt, f, s, t, c, fl);
  }
  void Set(LPCSTR capt,
           TOnChooseFillItems f,
           TOnChooseSelectItem s,
           TOnDrawThumbnail t,
           TOnChooseClose c,
