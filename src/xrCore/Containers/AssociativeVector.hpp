...
template <typename TKey,
          typename TValue,
          typename TKeyComparer = std::less<TKey>>
class AssociativeVector
    : protected std::vector<std::pair<TKey, TValue>>,
 ...
 public:
  ...
  IC AssociativeVector(TIterator first,
                       TIterator last,
                       const key_compare& predicate = key_compare(),
                       const allocator_type& allocator = allocator_type());
  IC AssociativeVector(const key_compare& predicate = key_compare(),
                       const allocator_type& allocator = allocator_type());
...
IC void swap(AssociativeVector<TKey, TValue, TKeyComparer>& left,
             AssociativeVector<TKey, TValue, TKeyComparer>& right);
...
IC _associative_vector::AssociativeVector(const key_compare& predicate,
...
TEMPLATE_SPECIALIZATION
template <typename TIterator>
IC _associative_vector::AssociativeVector(TIterator first,
                                          TIterator last,
...
TEMPLATE_SPECIALIZATION
IC void _associative_vector::reserve(size_t new_capacity) {
  inherited::reserve(new_capacity);
}
TEMPLATE_SPECIALIZATION
...
TEMPLATE_SPECIALIZATION
IC typename _associative_vector::TComparer _associative_vector::value_comp()
    const {
...
TEMPLATE_SPECIALIZATION
IC typename _associative_vector::insert_result _associative_vector::emplace(
    const key_type& key,
...
TEMPLATE_SPECIALIZATION
IC typename _associative_vector::TSelf& _associative_vector::operator=(
    const TSelf& right) {
