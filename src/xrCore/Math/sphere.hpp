...
struct Fsphere {
 ...
 public:
  ...
  ICF ERP_Result intersect(const Fvector3& S,
                           const Fvector3& D,
                           float range,
                           int& quantity,
                           float afT[2]) const {
   ...
   */
  ICF ERP_Result intersect_full(const Fvector3& start,
                                const Fvector3& dir,
                                float& dist) const {
    int quantity;
    float afT[2];
    typename Fsphere::ERP_Result result =
  ...
  ICF ERP_Result intersect(const Fvector3& start,
                           const Fvector3& dir,
                           float& dist) const {
    int quantity;
    float afT[2];
  ...
  ERP_Result intersect2(const Fvector3& S,
                        const Fvector3& D,
                        float& range) const {
    Fvector3 Q;
    Q.sub(P, S);
