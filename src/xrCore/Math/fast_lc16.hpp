...
class fast_lc16 final {
 ...
 public:
  ...
  static constexpr u32 a = 0x9e3779b1;  // a big prime number

 public:
  fast_lc16();

  explicit fast_lc16(u32 seed_v) { seed(seed_v); }

  explicit fast_lc16(u64 seed_v) { seed(seed_v); }

  fast_lc16(void* unique_ptr) { seed(uintptr_t(unique_ptr)); }
