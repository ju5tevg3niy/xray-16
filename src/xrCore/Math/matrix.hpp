...
struct Fmatrix {
  ...
  ICF SelfRef set(const Fvector& R,
                  const Fvector& N,
                  const Fvector& D,
                  const Fvector& C) {
    i.set(R);
  ...
  IC SelfRef translate(float _x,
                       float _y,
                       float _z)  // setup translation matrix
  {
    identity();
    c.set(_x, _y, _z);
    return *this;
  ...
  IC SelfRef translate_over(float _x,
                            float _y,
                            float _z)  // modify only translation
  {
    c.set(_x, _y, _z);
    return *this;
  }
  ...
  // fov
  IC SelfRef build_projection(float fFOV,
                              float fAspect,
                              float fNearPlane,
                              float fFarPlane) {
  ...
  IC SelfRef build_projection_HAT(float HAT,
                                  float fAspect,
                                  float fNearPlane,
                                  float fFarPlane) {
  ...
  IC SelfRef build_camera(const Fvector& vFrom,
                          const Fvector& vAt,
                          const Fvector& vWorldUp) {
  ...
  IC SelfRef build_camera_dir(const Fvector& vFrom,
                              const Fvector& vView,
                              const Fvector& vWorldUp) {
    // Get the dot product, and calculate the projection of the z basis
    // vector3 onto the up vector3. The projection is the y basis vector3.
  ...
  ICF void transform_tiny(Fvector& dest,
                          const Fvector& v) const  // preferred to use
  {
  ...
  ICF void transform_tiny23(Fvector& dest,
  ...
  ICF void transform_dir(Fvector& dest,
                         const Fvector& v) const  // preferred to use
  {
  ...
  IC SelfRef setXYZi(Fvector const& xyz) {
