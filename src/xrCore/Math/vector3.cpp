...
template <typename T>
_vector3<T>& _vector3<T>::clamp(const _vector3<T>& min,
                                const _vector3<T>& max) {
  ::clamp(x, min.x, max.x);
  ::clamp(y, min.y, max.y);
  ::clamp(z, min.z, max.z);
  return *this;
...
template <typename T>
_vector3<T>& _vector3<T>::average(const _vector3<T>& p1,
                                  const _vector3<T>& p2) {
  x = (p1.x + p2.x) * 0.5f;
  y = (p1.y + p2.y) * 0.5f;
  z = (p1.z + p2.z) * 0.5f;
...
template <typename T>
_vector3<T>& _vector3<T>::lerp(const _vector3<T>& p1,
                               const _vector3<T>& p2,
                               T t) {
  const T invt = 1.f - t;
  x = p1.x * invt + p2.x * t;
...
template <typename T>
_vector3<T>& _vector3<T>::mad(const _vector3<T>& p,
                              const _vector3<T>& d,
                              const _vector3<T>& s) {
  x = p.x + d.x * s.x;
  y = p.y + d.y * s.y;
...
_vector3<T>& _vector3<T>::normalize(const _vector3<T>& v) {
  VERIFY((v.x * v.x + v.y * v.y + v.z * v.z) > 0.0);
...
template <typename T>
_vector3<T>& _vector3<T>::random_dir(const _vector3<T>& ConeAxis,
                                     float ConeAngle,
                                     CRandom& R) {
  _vector3<T> rnd;
  rnd.random_dir(R);
...
template <typename T>
_vector3<T>& _vector3<T>::crossproduct(const _vector3<T>& v1,
                                       const _vector3<T>& v2) {
...
template <typename T>
_vector3<T>& _vector3<T>::reflect(const _vector3<T>& dir,
                                  const _vector3<T>& norm) {
  return mad(dir, norm, -2 * dir.dotproduct(norm));
}
template <typename T>
_vector3<T>& _vector3<T>::slide(const _vector3<T>& dir,
                                const _vector3<T>& norm) {
  // non normalized
...
template <typename T>
void _vector3<T>::generate_orthonormal_basis(const _vector3<T>& dir,
                                             _vector3<T>& up,
                                             _vector3<T>& right) {
  T fInvLength;
...
template <typename T>
void _vector3<T>::generate_orthonormal_basis_normalized(_vector3<T>& dir,
                                                        _vector3<T>& up,
                                                        _vector3<T>& right) {
  T fInvLength;
  dir.normalize();
...
// Barycentric coords
template <typename T>
_vector3<T>& _vector3<T>::from_bary(const _vector3<T>& V1,
                                    const _vector3<T>& V2,
                                    const _vector3<T>& V3,
                                    T u,
                                    T v,
...
template <typename T>
_vector3<T>& _vector3<T>::from_bary4(const _vector3<T>& V1,
                                     const _vector3<T>& V2,
                                     const _vector3<T>& V3,
                                     const _vector3<T>& V4,
                                     T u,
...
template <typename T>
_vector3<T>& _vector3<T>::mknormal_non_normalized(const _vector3<T>& p0,
                                                  const _vector3<T>& p1,
                                                  const _vector3<T>& p2) {
  _vector3<T> v01, v12;
  v01.sub(p1, p0);
...
template <typename T>
_vector3<T>& _vector3<T>::mknormal(const _vector3<T>& p0,
                                   const _vector3<T>& p1,
                                   const _vector3<T>& p2) {
...
template Fvector& Fvector::lerp(const Fvector& p1,
                                const Fvector& p2,
                                Fvector::TYPE t);
template Fvector& Fvector::mad(const Fvector& d, Fvector::TYPE m);
template Fvector& Fvector::mad(const Fvector& p,
                               const Fvector& d,
                               Fvector::TYPE m);
...
template Fvector& Fvector::random_dir(const Fvector& ConeAxis,
                                      float ConeAngle,
                                      CRandom& R);
...
template Fvector& Fvector::from_bary(const Fvector& V1,
                                     const Fvector& V2,
                                     const Fvector& V3,
                                     Fvector::TYPE u,
                                     Fvector::TYPE v,
...
template Fvector& Fvector::from_bary(const Fvector& V1,
                                     ...
                                     const Fvector& V3,
                                     const Fvector& B);
template Fvector& Fvector::from_bary4(const Fvector& V1,
                                      const Fvector& V2,
                                      const Fvector& V3,
                                      const Fvector& V4,
                                      Fvector::TYPE u,
...
template Fvector& Fvector::mknormal_non_normalized(const Fvector& p0,
                                                   const Fvector& p1,
                                                   const Fvector& p2);
template Fvector& Fvector::mknormal(const Fvector& p0,
                                    const Fvector& p1,
                                    const Fvector& p2);
...
template void Fvector::generate_orthonormal_basis(const Fvector& dir,
                                                  Fvector& up,
                                                  Fvector& right);
template void Fvector::generate_orthonormal_basis_normalized(Fvector& dir,
                                                             Fvector& up,
                                                             Fvector& right);
