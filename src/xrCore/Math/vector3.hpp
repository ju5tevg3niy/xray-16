...
struct _vector3 {
  ...
  // XXX: The vast majority of these basic math operations can be expressed as
  // non-class functions.
  ...
  SelfRef random_dir(const Self& ConeAxis,
                     float ConeAngle,
                     CRandom& R = ::Random);
  ...
  // Barycentric coords
  SelfRef from_bary(const Self& V1,
                    const Self& V2,
                    const Self& V3,
                    T u,
                    T v,
  ...
  SelfRef from_bary4(const Self& V1,
                     const Self& V2,
                     const Self& V3,
                     const Self& V4,
                     T u,
  ...
  SelfRef mknormal_non_normalized(const Self& p0,
                                  const Self& p1,
                                  const Self& p2);
  ...
  static void generate_orthonormal_basis(const _vector3<T>& dir,
                                         _vector3<T>& up,
                                         _vector3<T>& right);
  static void generate_orthonormal_basis_normalized(_vector3<T>& dir,
                                                    _vector3<T>& up,
                                                    _vector3<T>& right);
};
