...
class Fplane {
 ...
 public:
  ...
  ICF SelfRef build(const Fvector3& v1,
                    const Fvector3& v2,
                    const Fvector3& v3) {
    Fvector3 t1, t2;
  ...
  ICF SelfRef build_precise(const Fvector3& v1,
                            const Fvector3& v2,
                            const Fvector3& v3) {
    Fvector3 t1, t2;
  ...
  ICF BOOL intersectRayPoint(const Fvector3& P,
                             const Fvector3& D,
                             Fvector3& dest) {
    float numer = classify(P);
    float denom = n.dotproduct(D);
  ...
  IC BOOL intersect(const Fvector3& u,
                    const Fvector3& v,  // segment
  ...
  IC BOOL intersect_2(const Fvector3& u,
                      const Fvector3& v,  // segment
                      Fvector3& isect)    // intersection point
  {
    float dist1, dist2;
